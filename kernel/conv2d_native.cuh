...
#define CONV1_Co 8
#define CONV1_CALC_M_PER_WARP 4
#define CONV1_CALC_N_PER_WARP 8

#define CONV1_SHARED_M (CONV_KERNEL_K + CONV1_CALC_M_PER_WARP - 1)
#define CONV1_SHARED_N (CONV_KERNEL_K + CONV1_CALC_N_PER_WARP - 1)

#define CONV1_WARP_M (CONV1_Ho / CONV1_SHARED_M) //3
#define CONV1_WARP_N (CONV1_Wo / CONV1_SHARED_N) //2

#define CONV1_THREAD_PER_BLOCK ( CONV1_WARP_M * CONV1_WARP_N * 32 ) //192
